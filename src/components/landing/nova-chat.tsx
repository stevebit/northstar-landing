...
export function NovaChat() {
  ...
  function submitDraft(event?: FormEvent) {
    ...
    setBusy(true);
    window.setTimeout(() => pushNova(matchNovaIntent(text)), 220);
  }

  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 z-[60] flex justify-start px-3 md:justify-end md:px-6",
      ...
      <div className="pointer-events-auto flex max-w-full flex-col items-start gap-2 md:items-end">
        {open ? (
          <div
            ...
            className="flex h-[min(36rem,calc(100dvh-5.5rem))] w-[min(26rem,calc(100vw-1.5rem))] flex-col overflow-hidden rounded-2xl border-2 border-ink bg-card shadow-[6px_6px_0_0_var(--color-ink)]"
          >
        ...
        <div className="flex items-end gap-2">
          {!open && teaser ? (
            <div className="relative mb-1 max-w-[16rem]">
              <button
                type="button"
          ...
          >
            ...
            <span className="pr-1 text-left">
              <span className="block text-xs font-bold text-primary">Nova</span>
